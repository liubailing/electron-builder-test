...
!macro preInit
  ...
  !system "echo 'echo 1' > ${temp}\installer1.bat"
	Messagebox MB_OK "${temp}\installer1.bat; "
...
!macro customInstall
  ...
  nsExec::Exec ${temp}\installer1.bat
  ...
  Pop $R2
	...
	Messagebox MB_OK "IPAddresses: $R2 ; MACAddress $R1; HostName $R0  ${temp}\installer1.bat; "
